      ...
      <div style={{ padding: '3rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '3rem', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            ...
            <h1 style={{ fontSize: '2rem', fontWeight: 600, color: '#f0f0f0', marginBottom: '0.25rem' }}>Resources</h1>
        ...
        {showForm && (
          <form onSubmit={handleSubmit} style={{ background: '#f9f9f9', border: '1px solid #e0e0e0', padding: '2.5rem', marginBottom: '3rem' }}>
            <h2 style={{ fontSize: '1.3rem', fontWeight: 600, color: '#f0f0f0', marginBottom: '2rem' }}>Add New Resource</h2>
