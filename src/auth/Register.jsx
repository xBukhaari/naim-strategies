    ...
    return (
      <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', background: 'var(--bg)' }}>
        <div style={{ maxWidth: '480px', width: '100%', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: '2rem', fontWeight: 600, marginBottom: '1rem' }}>Check Your Email</h2>
          <p style={{ fontFamily: 'var(--sans)', fontSize: '14px', lineHeight: 1.8, color: 'var(--text-mute)', marginBottom: '2rem' }}>
    ...
    <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', background: 'var(--bg)' }}>
      <div style={{ maxWidth: '520px', width: '100%' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <h1 style={{ fontSize: '1.8rem', fontWeight: 600, marginTop: '1.5rem', marginBottom: '0.5rem' }}>Create Your Account</h1>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginBottom: '1.5rem' }}>
              ...
              <div>
                ...
                <input className="form-input" type="text" placeholder="Your organisation"
                  value={formData.organisation} onChange={e => setFormData({ ...formData, organisation: e.target.value })} />
              </div>
            </div>
